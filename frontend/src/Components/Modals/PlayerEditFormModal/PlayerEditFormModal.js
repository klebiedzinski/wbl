...
const PlayerEditFormModal = ({ setIsModalOpen, player }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      //get team id
      const team_id = values.teamName
        ? teams.find((team) => team.name === values.teamName)._id
        : teams.find((team) => team._id === player.team_id)._id;
      axiosInstance
        .patch(
          "/players/" + id,
          {
              ...
              <div className={styles.playerForm}>
                ...
                >
                  ...
                  <div className="input-container">
                    ...
                    />
                    {isSubmitClicked && (
                      <p className="validation-info">{formik.errors.picture}</p>
                    )}
                  </div>
                  ...
                  {isEdited && (
                    <p className="validation-info">Edytowano zawodnika</p>
                  )}
                </form>
              </div>
